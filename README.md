...
[![Build Status](https://img.shields.io/travis/sankarvijay/template-java-project/master.svg?style=flat-square)](https://travis-ci.org/sankarvijay/template-java-project)
[![SonarCloud Quality Gate](https://sonarcloud.io/api/project_badges/measure?project=fr.uparis10.sankarvijay%3Atemplate-java-project&metric=alert_status)](https://sonarcloud.io/dashboard?id=fr.uparis10.sankarvijay%3Atemplate-java-project)
[![SonarCloud Coverage](https://sonarcloud.io/api/project_badges/measure?project=fr.uparis10.sankarvijay%3Atemplate-java-project&metric=coverage)](https://sonarcloud.io/dashboard?id=fr.uparis10.sankarvijay%3Atemplate-java-project)
[![SonarCloud Technical Debt](https://sonarcloud.io/api/project_badges/measure?project=fr.uparis10.sankarvijay%3Atemplate-java-project&metric=sqale_index)](https://sonarcloud.io/dashboard?id=fr.uparis10.sankarvijay%3Atemplate-java-project)
<br/>
